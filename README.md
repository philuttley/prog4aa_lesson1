...
The lesson teaches novice programmers to write modular code to perform data analysis
...
The main example used in this lesson analyses a set of 12 files with simulated inflammation
